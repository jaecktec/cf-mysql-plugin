...
type FakeCfService struct {
	...
	OpenSshTunnelStub        func(cliConnection plugin.CliConnection, toService cfpsql.PsqlService, apps []sdkModels.GetAppsModel, localPort int)
	...
	GetServiceStub        func(connection plugin.CliConnection, name string) (cfpsql.PsqlService, error)
...
var _ cfpsql.CfService = new(FakeCfService)
